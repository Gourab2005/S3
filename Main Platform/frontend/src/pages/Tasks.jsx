...
const Tasks = () => {
  ...
  const openBotpressChat = () => {
    window.open(
      "https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2025/02/23/01/20250223013626-8WHNLBP2.json",
      "_blank",
      "noopener,noreferrer",
    )
  }
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-indigo-200 p-8">
      ...
      >
        <RiRobotLine className="text-4xl text-indigo-600 bg-white rounded-full p-2 shadow-lg" />
      </motion.div>
