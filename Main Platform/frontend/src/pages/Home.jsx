...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Stay connected with feedback from staff, students, and parents",
      icon: "🤝",
    },
    {
  ...
  const openModal = (index) => {
    if (features[index].title === "Standardization Support") {
      navigate("/Tasks");
    }else if(features[index].title === "Stakeholder feedback"){
      navigate("/Feedback");
    } else {
